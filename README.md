<div align="center">
  <img src="openAI.png" alt="Self-Healing Bug Agent" width="120" height="120">
...
### Sample Run
- No demo account is required; the app starts with built-in sample data.
- Use the manual workflow below to verify end-to-end behavior.
